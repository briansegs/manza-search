...
export const HeaderNav: React.FC<{ data: HeaderType }> = ({ data }) => {
  ...
  return (
    <div className="hidden h-16 bg-black lg:flex">
      <div className="bg-secondary-blue container flex w-2/3 items-center justify-between overflow-x-auto rounded-b-xl border-4 border-black">
...
export const MobileHeaderNav: React.FC<{ data: HeaderType }> = ({ data }) => {
  ...
  return (
    <div className="bg-secondary-blue flex p-4">
