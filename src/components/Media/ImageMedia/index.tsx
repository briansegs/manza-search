...
import { cssVariables, sizeMap } from '@/cssVariables'
...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  if (!publicIdFromProps && resource && typeof resource === 'object') {
    const { alt: altFromResource, height: fullHeight, cloudinary, width: fullWidth } = resource
